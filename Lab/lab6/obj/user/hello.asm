...
{
  8000e4:	872a                	mv	a4,a0
	size_t cnt = 0;
  8000e6:	4501                	li	a0,0
	while (cnt < len && *s++ != '\0') {
  8000e8:	e589                	bnez	a1,8000f2 <strnlen+0xe>
  8000ea:	a811                	j	8000fe <strnlen+0x1a>
		cnt++;
  8000ec:	0505                	addi	a0,a0,1
	while (cnt < len && *s++ != '\0') {
  8000ee:	00a58763          	beq	a1,a0,8000fc <strnlen+0x18>
  8000f2:	00a707b3          	add	a5,a4,a0
  8000f6:	0007c783          	lbu	a5,0(a5)
  8000fa:	fbed                	bnez	a5,8000ec <strnlen+0x8>
	}
	return cnt;
}
  8000fc:	8082                	ret
  ...
  80010c:	03067a33          	remu	s4,a2,a6
{
  ...
  800142:	40278793          	addi	a5,a5,1026 # 800540 <main+0x52>
	       ...
	       va_list ap)
{
  ...
  8001dc:	0ff5f593          	andi	a1,a1,255
  ...
  800220:	0ff5f593          	andi	a1,a1,255
